    ...
    <main className="h-auto flex flex-col items-center pb-30">
      ...
      <div className="flex justify-center items-center">
        <div className="bg-white flex flex-col gap-8 pl-10 pr-10 pt-10 p-10 max-w-4xl text-lg rounded-4xl">
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">1. O que é o HC Fácil?</h3>
          <p>
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">3. Quem pode usar o HC Fácil?</h3>
          <p>
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">4. O HC Fácil armazena meus dados pessoais?</h3>
          <p>
            Não. O site é apenas uma ferramenta educativa. Nenhuma informação
            sensível ou pessoal é salva.
          </p>
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">5. Como funciona o calendário interativo?</h3>
          <p>
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">6. Vou receber notificações reais pelo Telegram?</h3>
          <p>
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">7. Para que serve o chatbot?</h3>
          <p>
          ...
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">8. Os guias são escritos em linguagem fácil??</h3>
          <p>
            Sim! Todos os tutoriais são feitos com linguagem clara, passo a
            passo, com imagens e vídeos para ajudar o entendimento.
          </p>
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">9. Preciso me cadastrar para usar o HC Fácil?</h3>
          <p>
            Não. Todo o conteúdo é aberto e gratuito. Basta acessar o site e
            começar a usar.
          </p>
          <h3 className="bg-blue-200 h-15 pt-3 text-center text-2xl font-semibold rounded-2xl text-blue-800">10. Quem criou o HC Fácil?</h3>
          <p>
